...
<body>
	...
	<a style="font-size: 30px;color: #279; margin:20px; display:inline-block;text-decoration: none;" href="">Check Transports</a><br>
	<a style="font-size: 30px;color: #589; margin:20px; display:inline-block;text-decoration: none;" href="">Revenue</a><br>
	<a style="font-size: 30px;color: #589; margin:20px; display:inline-block;text-decoration: none;" href="/websport/logoutSeller">Log out</a><br>
